...
app.service('productService', function () {
    ...
    this.AddBook = function (Name: string, Category: string, Price: number, ArticleNumber: number, Author: string, ReleaseYear: number) {
        let newBook = new Entities.Book(Name, Category, Price, ArticleNumber, Author, ReleaseYear);
        Books.push(newBook);
    }
